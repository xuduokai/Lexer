...
import com.xu.input.MacroHandler;
import com.xu.input.RegularExpressionHandler;
import com.xu.input.system.Input;
import com.xu.newdfa.DfaConstructor;
import com.xu.newminimizedfa.MinimizeDFA;
import com.xu.newnfa.NfaIntepretor;
import com.xu.newnfa.NfaMachineConstructor;
import com.xu.newnfa.NfaPair;
...
public class ThompsonConstruction {
    ...
    private void printLexResult() {
        while (!lexer.MatchToken(Lexer.Token.EOS)) {
            ...
            charSet.add((char) lexer.getLexeme());
    ...
    private void runMinimizeDFAExample() {
        miniDfa = new MinimizeDFA(dfaConstructor, charSet);
